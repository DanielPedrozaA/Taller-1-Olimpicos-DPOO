...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Buscal el pais al que el/la atleta ingresado por parametro representa en los
	 * olimpicos
	 * 
	 * @param nombreAtleta   El nombre del atleta de interes.
	 * @return Un String que es el nombre del pais al que representa el/la atleta
	 */
