...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais que representa el/la atleta");
		System.out.println("14. Salir de la aplicación\n");
	}
	
	/**
	 * Le muestra el usuario a que pais que representa el/la atleta que esta buscando
	 */
	private void ejecutarPaisQueRepresenta()
	{
		System.out.println("\n" + "Pais que representa el/la atleta buscado" + "\n");
		String nombreAtleta = input("Por favor ingrese el nombre de el/la atleta");
		String resultado = calculadora.paisQueRepresenta(nombreAtleta);
		if (resultado == null)
		{
			System.out.println("El/la atleta que busca no se encuentra. Porfavor intente con otro nombre");
		}
		else
			
		{
			System.out.println("El/la atleta " + nombreAtleta + " representa al pais " + resultado);
		}
	}
	/**
